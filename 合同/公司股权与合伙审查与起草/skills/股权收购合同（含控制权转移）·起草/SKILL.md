---
name: 股权收购合同（含控制权转移）·起草
description: 按已谈妥条件起草股权收购合同（含控制权转移）并自审：控制权路径写死，付款与改组／印章移交同步，先决条件闭合；经营者集中事先申报；买股权即概括承受债务。
---
...
本原子只承担本类型起草。待签评改转 `股权收购合同（含控制权转移）·审查`。无完整待签文本、但本类型条件已谈妥、要出己方稿时，留在本任务，不转 `股权收购合同（含控制权转移）·起草`。
