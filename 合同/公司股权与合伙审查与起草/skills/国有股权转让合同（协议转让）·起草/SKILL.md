---
name: 国有股权转让合同（协议转让）·起草
description: 按已谈妥条件起草国有股权转让合同（协议转让）并自审：签字成立、批准后生效；非公开仅限法定两类例外；优先购买书面通知；协议转让价不得低于评估结果。
---
...
本原子只承担本类型起草。待签评改转 `国有股权转让合同（协议转让）·审查`。无完整待签文本、但本类型条件已谈妥、要出己方稿时，留在本任务，不转 `国有股权转让合同（协议转让）·起草`。
