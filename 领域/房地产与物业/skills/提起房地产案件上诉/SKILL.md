...
形成上诉状、上诉范围、期限和理由。不重做一审。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：不服尚未生效的一审裁判，决定上诉。
...
宿主可调用时：核验民诉法上诉期限现行条文（判决十五日、裁定十日，条号运行时核验）。期限字段不可用则停止截止日。
...
只针对不服部分。一审未请求且非必要的新请求受限。

### 节点 3　理由

事实认定、法律适用、程序违法分列，不发泄情绪。

### 节点 4　新证据

符合二审新证据条件才列入，不把怠于举证改称新证据。
