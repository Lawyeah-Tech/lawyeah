---
name: 评估共有部分收益与车位
description: 专有或共有识别、首先满足业主、收益归属
---
...
识别专有或共有、车位是否首先满足业主、收益归属。规划许可行政诉讼转行政。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：车位车库、外墙广告、会所或共有部位收益归属有争议。
...
确认：规划用途；销售合同是否已出售车位；面积是否分摊入业主购房款；实际占用。
...
宿主可调用时：`search_law` 核验民法典第 274–276、282 条及建筑物区分所有权解释。
...
规划为车库且未分摊、独立登记：专有候选。占用共有道路的车位：共有。
...
- `整体停止`：用户坚持把人防车位当可自由买卖专有而不核验。
- `字段停止`：第 274–276、282 条或人防规范未核验。
- `目标停止`：主目标变为规划行政诉讼。
