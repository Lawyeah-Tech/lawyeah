---
name: 准备探矿权采矿权申请材料
description: 准备探矿权或采矿权新设或延续申请材料与缺件
---
...
在明确、无利益冲突的申请人立场下，形成“探矿权或采矿权申请包”：申请材料、缺件、出让合同接口。不保证颁发许可证。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：已决定申请新设或延续探矿权、采矿权。
...
确认：使用者与授权；单方立场（申请人）；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验矿产资源法（2024 修订）申请、出让、延续条件；与旧转让办法冲突时以新法核验为准。 不虚构案件系统。核验重点：矿产资源法（2024 修订，2025-07-01 施行）、矿业权出让、登记规则。
...
- `整体停止`：指导无证抢采或伪造地质资料；利益冲突未解；基础主体无法建立。
- `字段停止`：新矿法申请条件未核验；法域、日期、文书送达、动态规则未核验。
- `目标停止`：主目标变为并购交易或土地报批。
