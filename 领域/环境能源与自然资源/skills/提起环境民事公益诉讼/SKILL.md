---
name: 提起环境民事公益诉讼
description: 准备环境民事公益诉讼的资格、违法性、损害和请求
---
...
在明确、无利益冲突的原告代理人立场下，形成“环境民事公益诉讼起诉包”：主体资格、违法性、风险或损害、请求。不冒充检察机关。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：社会组织或检察机关接口已决定提起环境民事公益诉讼。

负触发并输出 `触发判定：负触发，未启动本任务`：

- 冒充检察机关或伪造社会组织资格；
- 省政府或市政府指定部门的生态损害赔偿诉讼（另项）；
- 私益渔损或健康索赔主成果；
- 代提交立案；
...
确认：使用者与授权；单方立场（原告代理人（社会组织或检察机关接口））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验民诉法公益诉讼、环境民事公益诉讼解释、社会组织资格、检察公告程序。 不虚构案件系统。核验重点：民事诉讼法公益诉讼、环境民事公益诉讼解释、环境保护法社会组织条款。
...
- `整体停止`：冒充检察机关或伪造社团资格；利益冲突未解；基础主体无法建立。
- `字段停止`：公益诉讼资格和前置程序未核验；法域、日期、文书送达、动态规则未核验。
