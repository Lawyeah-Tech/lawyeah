---
name: 测算污染人身财产损失
description: 分项测算污染造成的人身财产损失，不与生态损害加总
---
...
在明确、无利益冲突的单方立场下，形成“污染人身财产损失分项测算表”：渔损、作物、健康、清理费用、减损、鉴定接口。不替代生态修复精算。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：渔损、作物、健康或清理费用需要分项数字，受害人或抗辩方需要可复核工作表。
...
确认：使用者与授权；单方立场（受害人或抗辩方（强制单方））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验民法典损害赔偿、环境侵权解释财产与人身项目、减损规则；鉴定方法不虚构单价。 不虚构案件系统。核验重点：民法典损害赔偿、环境侵权解释、人身损害赔偿相关解释接口。
...
- `整体停止`：用户坚持未知当零或伪造基线；利益冲突未解；基础主体无法建立。
- `字段停止`：赔偿项目范围、扣减规则未核验；法域、日期、文书送达、动态规则未核验。
