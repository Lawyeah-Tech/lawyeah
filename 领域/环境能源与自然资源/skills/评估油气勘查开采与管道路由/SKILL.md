---
name: 评估油气勘查开采与管道路由
description: 判断油气矿业权、管道路由保护和补偿接口
---
...
在明确、无利益冲突的单方立场下，形成“油气勘查开采与管道路由矩阵”：矿业权与管道保护、补偿接口。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：油气矿业权、管线路由或保护发生争议。
...
确认：使用者与授权；单方立场（权利人或沿线权利人（强制单方））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验矿产资源法油气特别规定接口、石油天然气管道保护法、保护范围。 不虚构案件系统。核验重点：矿产资源法、石油天然气管道保护法、相关保护范围规则。
...
- `整体停止`：破坏管道或违章占压作业指导；利益冲突未解；基础主体无法建立。
- `字段停止`：管道保护范围、油气矿权规则未核验；法域、日期、文书送达、动态规则未核验。
- `目标停止`：主目标变为工程结算或征地包。
