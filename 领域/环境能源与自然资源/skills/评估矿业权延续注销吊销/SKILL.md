---
name: 评估矿业权延续注销吊销
description: 判断矿业权延续条件、吊销事由和存续的修复义务
---
...
在明确、无利益冲突的权利人立场下，形成“矿业权延续、注销、吊销矩阵”：延续条件、吊销事由、修复义务不因消灭免除。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：许可证到期、责令改正未改或拟被吊销。
...
宿主可调用时：search_law 核验矿产资源法延续、注销、吊销、修复义务不因权利消灭免除。 不虚构案件系统。核验重点：矿产资源法、矿山生态修复相关规则。
...
- `整体停止`：指导抢采或伪造停产；利益冲突未解；基础主体无法建立。
- `字段停止`：延续和吊销规则未核验；法域、日期、文书送达、动态规则未核验。
