---
name: 评估陆源污染海洋责任
description: 判断陆源入海排污责任并与船舶污染分界
---
...
在明确、无利益冲突的陆源排污者立场下，形成“陆源污染海洋责任矩阵”：入海排污口、倾废、海环法与环保法分账、与船舶污染分界、民事和监管接口。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：岸上排污、入海排污口或向海倾废被追究，陆源排污者需要责任和分界判断。
...
确认：使用者与授权；单方立场（陆源排污者）；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验海洋环境保护法陆源污染专章、海洋倾废、入海排污口、环保法与海环法竞合；船舶条款只作分界。 不虚构案件系统。核验重点：海洋环境保护法、海洋倾废管理条例接口、环境保护法、排污许可。
...
- `整体停止`：立场不明；用户坚持向海偷排；利益冲突未解；基础主体无法建立。
- `字段停止`：海环法陆源条款、倾废许可、分界未核验；法域、日期、文书送达、动态规则未核验。
- `目标停止`：主目标变为船舶油污案件。
