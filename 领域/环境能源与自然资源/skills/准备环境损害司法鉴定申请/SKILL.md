---
name: 准备环境损害司法鉴定申请
description: 准备环境损害司法鉴定事项、检材和申请稿
---
...
在明确、无利益冲突的单方立场下，形成“环境损害司法鉴定申请包”：鉴定事项、检材、机构分流、申请稿。不预测鉴定意见。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：需鉴定机构确认污染、因果或修复费用。
...
宿主可调用时：search_law 核验环境损害司法鉴定管理、民事诉讼鉴定程序接口；不虚构机构资质结论。 不虚构案件系统。核验重点：民事诉讼鉴定规则、环境损害司法鉴定相关规范。
...
- `整体停止`：用户坚持污染或伪造检材；利益冲突未解；基础主体无法建立。
- `字段停止`：鉴定管理规则、委托程序未核验；法域、日期、文书送达、动态规则未核验。
