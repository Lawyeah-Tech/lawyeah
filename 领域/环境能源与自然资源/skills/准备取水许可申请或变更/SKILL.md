---
name: 准备取水许可申请或变更
description: 准备取水许可申请或变更材料、论证和计量安排
---
...
在明确、无利益冲突的申请人立场下，形成“取水许可申请或变更包”：申请材料、论证、计量。不保证许可。
...
宿主可调用时：search_law 核验取水许可申请条件、变更情形、计量设施。 不虚构案件系统。核验重点：水法、取水许可管理办法、水资源论证管理办法接口。
...
- `整体停止`：伪造水平衡或计量；利益冲突未解；基础主体无法建立。
- `字段停止`：申请条件未核验；法域、日期、文书送达、动态规则未核验。
