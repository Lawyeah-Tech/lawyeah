---
name: 提起自然资源权利诉讼
description: 准备自然资源权利诉讼并分流民事或行政路径
---
...
在明确、无利益冲突的原告立场下，形成“自然资源权利诉讼起诉包”：起诉材料、行政附带或民事诉讼分流。土地承包、房地权属转对应领域。
...
确认：使用者与授权；单方立场（原告）；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验矿业权纠纷解释民事受案、行政行为效力、取水权争议路径。 不虚构案件系统。核验重点：矿产资源法、矿业权纠纷解释、水法、行政诉讼法与民事诉讼法分界。
...
- `整体停止`：虚假权属陈述；利益冲突未解；基础主体无法建立。
- `字段停止`：民行分界、解释条文未核验；法域、日期、文书送达、动态规则未核验。
