---
name: 提起生态环境损害赔偿诉讼
description: 核验磋商前置并准备生态环境损害赔偿诉讼材料
---
...
在明确、无利益冲突的原告代理人立场下，形成“生态环境损害赔偿诉讼起诉材料包”：磋商前置核验、请求范围、与公益和私益的分界。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：磋商不成或依法可诉，权利人指定部门拟起诉。
...
确认：使用者与授权；单方立场（原告代理人（赔偿权利人指定部门））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验生态环境损害赔偿管理规定诉讼主体、磋商前置例外、民法典第 1234–1235 条请求范围。 不虚构案件系统。核验重点：生态环境损害赔偿管理规定、民法典第 1234–1235 条、相关司法解释。
...
- `整体停止`：冒充指定部门或伪造磋商破裂；利益冲突未解；基础主体无法建立。
- `字段停止`：主体、前置、请求范围未核验；法域、日期、文书送达、动态规则未核验。
