---
name: 评估野生动植物与保护地红线
description: 判断保护地红线、名录和禁止活动及刑事红旗
---
...
在明确、无利益冲突的单方立场下，形成“野生动植物与保护地红线矩阵”：名录、分区管控、禁止活动、处罚与刑事红旗。不定罪。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：保护地、红线、禁猎或栖息地破坏被查或选址触及。
...
确认：使用者与授权；单方立场（建设单位或被查处人（强制单方））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验野生动物保护法、自然保护地、生态保护红线、刑法危害珍贵濒危野生动物等红旗。 不虚构案件系统。核验重点：野生动物保护法、湿地保护法、自然保护区条例／国家公园法接口、刑法相关罪（红旗）。
...
- `整体停止`：指导偷猎或毁栖息地；利益冲突未解；基础主体无法建立。
- `字段停止`：名录、分区、刑事立案标准未核验；法域、日期、文书送达、动态规则未核验。
- `目标停止`：主目标变为定罪辩护或房地拿地。
