---
name: 评估矿业权转让合同与报批
description: 判断矿业权转让合同约束力、报批条件和无效主张边界
---
...
在明确、无利益冲突的单方立场下，形成“矿业权转让合同与报批矩阵”：合同约束力、报批条件、无效主张边界。未成争改合同走审查起草（搁置）。矿业股权并购整案转出。
...
确认：使用者与授权；单方立场（转让人或受让人（强制单方））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验矿产资源法、矿业权纠纷解释第 2 条及以下、转让管理办法与新法冲突。 不虚构案件系统。核验重点：矿产资源法（2024）、矿业权纠纷解释（2020 修正）、转让管理规则（须与新法核验）。
...
- `整体停止`：指导无证开采；伪造报批；利益冲突未解；基础主体无法建立。
- `字段停止`：新矿法与转让规则冲突未核验；法域、日期、文书送达、动态规则未核验。
