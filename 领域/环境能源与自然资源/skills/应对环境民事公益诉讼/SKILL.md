---
name: 应对环境民事公益诉讼
description: 准备环境民事公益诉讼的资格异议和修复抗辩
---
...
在明确、无利益冲突的被告立场下，形成“环境民事公益诉讼应诉包”：主体资格异议、违法性、修复抗辩。与私益应诉、生态损害赔偿应诉分开。
...
宿主可调用时：search_law 核验公益诉讼原告资格、公告、修复责任、惩罚性在公益中的适用边界。 不虚构案件系统。核验重点：环境民事公益诉讼解释、民法典生态修复条款、民事诉讼法答辩。
...
- `整体停止`：威胁原告或毁证；利益冲突未解；基础主体无法建立。
- `字段停止`：资格规则、答辩期限未核验；法域、日期、文书送达、动态规则未核验。
- `目标停止`：主目标变为私益或政府索赔应诉。
