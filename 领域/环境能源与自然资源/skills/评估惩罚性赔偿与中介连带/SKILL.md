---
name: 评估惩罚性赔偿与中介连带
description: 判断环境惩罚性赔偿和中介连带是否具备条件
---
...
在明确、无利益冲突的单方立场下，形成“惩罚性赔偿与中介连带矩阵”：故意、违法性、严重后果、连带情形。不给倍数必得额。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：拟主张或抗辩惩罚性赔偿，或环评、监测、运维机构连带。
...
宿主可调用时：search_law 核验民法典第 1232 条、法释〔2022〕1 号、环保法第 65 条、环境侵权解释第 21 条。 不虚构案件系统。核验重点：民法典第 1232 条、法释〔2022〕1 号、环境保护法第 65 条、环境侵权解释。
...
- `整体停止`：伪造故意或贿赂取证；利益冲突未解；基础主体无法建立。
- `字段停止`：惩罚性解释、连带条文未核验；法域、日期、文书送达、动态规则未核验。
