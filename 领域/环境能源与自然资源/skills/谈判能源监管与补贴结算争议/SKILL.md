---
name: 谈判能源监管与补贴结算争议
description: 形成能源监管约谈或补贴结算谈判的让步与承诺边界
---
...
在明确、无利益冲突的单方立场下，形成“能源监管与补贴结算谈判方案”：让步、合规承诺、弃权。不替代处罚申辩。
...
宿主可调用时：search_law 核验电力监管、可再生能源补贴结算、监管约谈性质；处罚程序转申辩原子。 不虚构案件系统。核验重点：电力监管条例、可再生能源法、行政处罚法与监管约谈分界。
...
- `整体停止`：虚假承诺或骗补；利益冲突未解；基础主体无法建立。
- `字段停止`：监管权限、补贴规则未核验；法域、日期、文书送达、动态规则未核验。
