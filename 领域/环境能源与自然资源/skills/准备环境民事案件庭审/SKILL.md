---
name: 准备环境民事案件庭审
description: 准备环境民事庭审争点、质证和鉴定询问提纲
---
...
在明确、无利益冲突的单方代理立场下，形成“环境民事案件庭审准备包”：争点、举证质证、鉴定询问提纲。不代替立案。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：侵权、公益或生态损害赔偿已开庭或即将开庭。
...
确认：使用者与授权；单方立场（单方代理）；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验环境资源审判举证、鉴定人出庭、证据规定；行政或刑事庭审不展开。 不虚构案件系统。核验重点：民事诉讼法、环境民事证据规定、环境资源审判相关解释。
...
- `整体停止`：伪证或威胁证人鉴定人；利益冲突未解；基础主体无法建立。
- `字段停止`：举证时限、出庭规则未核验；法域、日期、文书送达、动态规则未核验。
