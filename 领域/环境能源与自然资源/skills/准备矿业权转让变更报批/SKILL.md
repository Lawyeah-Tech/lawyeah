---
name: 准备矿业权转让变更报批
description: 准备矿业权转让变更报批材料并核对证照一致性
---
...
在明确、无利益冲突的单方立场下，形成“矿业权转让变更报批材料包”：报批材料、合同与许可证一致性。未经批准不得写成已变更。
...
宿主可调用时：search_law 核验变更登记申请要件、公示、审批时限接口。 不虚构案件系统。核验重点：矿产资源法、矿业权登记与转让报批规则。
...
- `整体停止`：伪造清税或权属无争议声明；利益冲突未解；基础主体无法建立。
- `字段停止`：报批要件未核验；法域、日期、文书送达、动态规则未核验。
