---
name: 评估环境污染侵权请求或抗辩
description: 判断环境污染私益侵权请求或抗辩能否立住
---
...
在明确、无利益冲突的单方立场下，形成“环境污染侵权请求或抗辩矩阵”：无过错、关联性、因果举证、免责减责、惩罚性接口和下一步。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：污染已致人身或财产损害，需判断请求或抗辩能否立住。
...
确认：使用者与授权；单方立场（受害人或被指侵权人（强制单方））；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验民法典第 1229–1233 条、环境侵权解释、证据规定第 5 条、惩罚性解释；不把举证责任倒置写成原告无需关联性。 不虚构案件系统。核验重点：民法典第 1229–1233 条、最高人民法院环境侵权解释、环境民事证据规定。
...
- `整体停止`：立场冲突；用户坚持伪造监测或虚假伤情；利益冲突未解；基础主体无法建立。
- `字段停止`：侵权构成、举证分配、时效未核验；法域、日期、文书送达、动态规则未核验。
