---
name: 应对自然资源权利诉讼
description: 准备自然资源权利诉讼的权属和报批抗辩
---
...
在明确、无利益冲突的被告立场下，形成“自然资源权利诉讼应诉包”：答辩、权属抗辩、报批抗辩。与环境侵权应诉不同。

`depends-on` 为空。接受用户、律师、机关或其他来源的等价事实、测算和证据清单。

## 工作边界

正触发：已收到矿业权、取水权等权利诉讼起诉状。
...
确认：使用者与授权；单方立场（被告）；相对方、主管机关及可能责任主体；关键文本版本；法域；当前检查、处罚、协商、诉讼或执行状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：search_law 核验矿业权纠纷解释抗辩、登记对抗、报批义务。 不虚构案件系统。核验重点：矿产资源法、矿业权纠纷解释、水法、民事诉讼法答辩。
...
- `整体停止`：转移矿产品或伪造权属；利益冲突未解；基础主体无法建立。
- `字段停止`：民行分界、答辩期限未核验；法域、日期、文书送达、动态规则未核验。
