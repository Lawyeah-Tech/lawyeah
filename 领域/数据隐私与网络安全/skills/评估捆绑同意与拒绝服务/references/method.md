...
固定列：`编号｜功能｜是否基本｜对应权限／处理｜拒绝后果｜是否捆绑｜误导胁迫｜频繁征求｜判断｜待核`。
...
- 若 已下架或被通报只要整改报告：则 转 `应对App下架通报与整改`
- 若 只要种类是否必要、交互不是争点：则 转最小必要原子
- 若 用户要 C 端 App 审查清单：则 只分流不回改

## 节点 2　基本功能

- 若 功能是登录后浏览或完成已购服务：则 基本功能候选
- 若 功能是个性化推荐或广告：则 不得写成基本功能
- 若 处理者把全部功能称为基本功能：则 认定依据不足，须拆分

## 节点 3　捆绑与拒绝后果

运行时核验第 16 条。

- 若 拒绝非必要处理即无法使用基本功能：则 捆绑成立候选，现有依据不支持该拒绝提供
- 若 多个目的一个总开关且不可分选：则 自愿明确不支持
- 若 该处理确为基本功能所必需：则 拒绝提供可支持，但必须证明必需

## 节点 4　误导与频繁

- 若 文案暗示不授权会违法或账号被盗且无依据：则 误导胁迫红旗
- 若 个人明确拒绝后仍反复弹窗：则 条例第 22 条红旗
- 若 预勾选同意：则 明确不支持

## 节点 5　整改接口

- 若 可拆分同意且基本功能可独立使用：则 整改方向成立
- 若 用户要下架复测材料包：则 转下架原子
