---
name: 准备监管整改报告
description: 准备可核验的监管整改报告结构，不把计划写成已完成
---
...
宿主可调用时：`search_law` 核验责令改正相关条款。范本只借结构。不虚构案件系统。

工具不可用时继续主体、场景、系统和问题清单；依赖未核验规则的法律结论、期限或机关路径字段停止。

## 五个判断节点

执行顺序和停止条件以 [整改报告方法](references/method.md) 为准。这里只列入口，不代替节点。
