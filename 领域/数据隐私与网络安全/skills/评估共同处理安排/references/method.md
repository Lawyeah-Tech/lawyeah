...
固定列：`编号｜各方｜谁定目的｜谁定方式｜对外名义｜行权对象｜内部约定｜连带接口｜判断｜待核`。
...
- 若 双方共同决定目的和方式：则 共同处理主位
- 若 一方只提供存储算力并按指示：则 委托候选，转委托原子
- 若 一方向另一方提供后对方独立决定新目的：则 对外提供候选
- 若 事实冲突：则 并列两种角色，不选有利项

## 节点 2　对外

- 若 共同处理成立：则 个人可向任一方行使权利；对外连带接口必须写明
- 若 协议写“各自独立、互不连带”对抗个人：则 该条款对个人不支持，对内可作缺口

## 节点 3　对内约定

- 若 未约定各自义务：则 内部缺口，不影响对外判断
- 若 用户要整份合资合同审查：则 审查起草搁置

## 节点 4　告知与 PIPIA

- 若 告知未列共同处理各方：则 告知缺口，转告知原子
- 若 共同处理触发第 55 条：则 打开 PIPIA

## 节点 5　输出

- 若 认定依据不足：则 不得写成已成立共同处理或已排除共同处理
- 若 认定支持：则 输出连带接口和内部约定要点
