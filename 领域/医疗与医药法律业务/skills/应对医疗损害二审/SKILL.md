...
在明确、无利益冲突的被上诉方立场下，形成“二审答辩和补充鉴定意见”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：已收到医疗损害上诉状，需要二审答辩和鉴定立场。
...
本任务不代替主动上诉，不保证维持原判，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；上诉状、一审判决、送达日、己方是否一并上诉、鉴定状态；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验民事诉讼法二审程序、医疗损害责任解释；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；答辩期间和法律适用结论字段停止。
