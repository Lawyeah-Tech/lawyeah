---
name: 评估临床用血与输血管理
description: 评估临床用血核查、血袋管理和不合格血液接口
---
...
在明确、无利益冲突的机构方立场下，形成“用血制度缺口、不合格血液接口”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：输血适应证、交叉配血或血袋管理出现检查或不良后果，需要用血合规评估。
...
本任务产品责任诉讼另项，不写输血医学方案，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；输血申请、交叉配血、血袋号、核查记录、不良反应、血站；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验献血法、医疗机构临床用血管理办法、民法典第一千二百二十三条；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；用血核查义务和不合格血液接口法律结论字段停止。
...
- `整体停止`：立场不明；销毁血袋或补造配血记录。
- `字段停止`：临床用血规则未核验。
- `目标停止`：主目标变为产品诉讼或封存操作或医学方案。
