---
name: 审查医疗广告与宣传合规
description: 审查医疗广告禁载事项、审批备案和违法后果
---
...
在明确、无利益冲突的机构方立场下，形成“禁载事项、审批／备案、违法后果”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：医疗广告、科室宣传或疗效承诺需要合规判断。
...
本任务一般商业广告转广告审查商品，不办品牌全案，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；宣传物料、发布渠道、是否医疗广告审批、科室与医师姓名、疗效表述；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验广告法医疗广告规范、医疗广告管理办法、医师法不得虚假宣传等现行条款；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；禁载事项和审批效力法律结论字段停止。
...
- `整体停止`：立场不明；要求提供规避审批的发布方案。
- `字段停止`：医疗广告禁载或审批规则未核验。
- `目标停止`：主目标变为品牌全案、普通广告或推广贿赂。
