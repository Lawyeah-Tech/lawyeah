...
在明确、无利益冲突的医师或机构立场下，形成“注册状态、超范围、机构连带”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：注册地点、类别或执业范围争议，需要评估超范围和机构连带。
...
本任务劳动身份走劳动，吊销处罚另项，不定罪，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；医师执业证书、注册机构、类别范围、实际手术或处方、机构安排；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验医师法执业注册、执业规则、医疗机构安排医师执业的义务；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；注册效力和超范围后果法律结论字段停止。
...
- `整体停止`：立场不明；伪造注册或要求开脱犯罪。
- `字段停止`：医师注册规则未核验。
- `目标停止`：主目标变为劳动、处罚申辩或刑事辩护。
