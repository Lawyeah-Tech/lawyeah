---
name: 评估医院感染管理合规
description: 评估医院感染管理制度、报告义务和责任接口
---
...
在明确、无利益冲突的机构方立场下，形成“院感制度、报告、责任接口”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：院感暴发或医院感染管理检查，需要合规和责任接口。
...
本任务不定医学感染源，群体事件另项 unavailable，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；院感制度、监测数据、暴发线索、报告记录、消毒隔离；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验医院感染管理办法、传染病防治法交叉条款、医疗质量安全事件报告规范；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；院感报告义务和法律后果字段停止。
