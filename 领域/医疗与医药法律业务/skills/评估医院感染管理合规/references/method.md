...
| --- | --- | --- |
| 院感暴发或检查 | 制度、监测、报告缺口 | 判定病原和传染源 |
| 群体同一诊疗伤害策略 | unavailable（P2） | 在本任务做共同诉讼策略 |
| 传染病漏报 | 可并列传染病义务原子 | 用院感办法代替传染病法 |
| 患者索赔总图 | 转评估原子，本任务只留合规接口 | 写成院感管理即全责 |
