---
name: 评估医保拒付与定点协议争议
description: 评估医保拒付追回理由、定点协议和监管民事分流
---
...
在明确、无利益冲突的机构或患者立场下，形成“拒付理由、协议、监管／民事分流”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：医保拒付、追回或骗保红旗需要评估。
...
本任务普通商业保险转保险商品，骗保刑责转刑事，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；拒付或追回文书、定点协议、项目编码、病历与收费、患者个人账户；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验社会保险法、医疗保障基金使用监督管理条例、定点协议相关规则待核；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；拒付效力和协议责任法律结论字段停止。
