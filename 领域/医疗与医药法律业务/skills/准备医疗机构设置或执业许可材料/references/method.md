...
| --- | --- | --- |
| 新设、变更科目地址或校验 | 组织材料清单 | 保证批准 |
| 房屋租赁或设备采购合同要审查 | 审查起草搁置 | 在本任务改合同 |
| 只要评估能否超范围继续干 | 转许可评估 | 用申报稿代替评估 |
| GMP／GSP 认证 | 转药企质量原子或认证咨询 | 当医疗机构许可 |
...
1. 类型不明：先固定一项。
2. 地方实施细则未核验：受理条件字段停止。
3. 互联网诊疗另有准入：转互联网医院原子接口。

若材料冲突：并列版本，不选对用户有利的一版冒充唯一事实。
若规则未核验：本节点法律结论字段停止，仍可列事实和缺口。
禁止写成：把设置申请和执业登记混成一套必然一次批出的材料。
...
1. 用户要改租赁或合作协议：说明本窗搁置。
2. 只记录合同是否存在、期限是否覆盖申请。
3. 文本冲突并列。
