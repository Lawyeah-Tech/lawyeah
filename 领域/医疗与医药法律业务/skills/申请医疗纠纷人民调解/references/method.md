...
| --- | --- | --- |
| 双方或一方申请医调委 | 可准备申请材料 | 对方必须参加 |
| 条例中的三十个工作日等办理期名称 | 摘录期间名称；鉴定时间不计入等规则待核 | 写成起诉障碍 |
| 超期未达成 | 视为调解不成 | 自动延长并禁止起诉 |
| 已有方案要评估 | 转方案评估原子 | 用申请稿代替评估 |
...
1. 对方明确拒绝：说明可直接协商、诉讼或其他路径。
2. 用户要求强迫调解：负触发该部分。
3. 已立案是否仍可调：待核，不写唯一规则。
