---
name: 评估精神障碍收治与非自愿住院
description: 评估精神障碍非自愿住院条件、告知复诊和救济
---
...
在明确、无利益冲突的患方、监护人或机构立场下，形成“收治条件、告知、复诊、救济”。

`depends-on` 为空。接受用户、律师、医学专家、机关或其他来源的等价事实、病历、鉴定、许可和费用清单。

## 工作边界

正触发：非自愿住院、约束或出院争议需要合法性评估。
...
本任务不定精神医学诊断，人身自由刑事强制转刑事，不给胜诉率，不指导伪造、抢夺、威胁、隐匿病历或中断救治取证。

## 建立坐标

确认：使用者与授权；单方立场；收治决定、监护人、危险性线索、告知、复诊、约束记录、出院申请；法域；当前投诉、封存、鉴定、调解、监管或诉讼状态；机关文书作出与送达；对方已知主张；关键材料及缺失。
...
宿主可调用时：`search_law` 核验精神卫生法非自愿住院、复诊和救济现行条款；`search_practiced` 补路径与反例；特殊事实用 `search_case_by_fact`。不虚构鉴定、许可或案件系统。

工具不可用时继续事实、主体、材料和问题清单；收治条件和救济路径法律结论字段停止。
...
- `整体停止`：立场不明；无条件强行收治或伪造自愿。
- `字段停止`：精神卫生法收治条件未核验。
- `目标停止`：主目标变为医学诊断、刑事强制或普通损害评估。
