...
1. **子女位置与即时安全核验**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **既有照护权限和事件证据链**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **紧急救济与协同路径表**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **申请材料、禁止动作和后续分流**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
