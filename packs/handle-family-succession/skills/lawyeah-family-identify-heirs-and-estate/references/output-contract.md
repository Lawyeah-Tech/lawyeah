...
1. **继承开始与主体关系图**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **继承依据和状态表**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **遗产、他人财产与债务台账**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **证据缺口、保全风险和后续入口**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
