...
1. **即时危险和安全沟通状态**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **撤离报警医疗庇护计划**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **儿童老人和重要物品保护清单**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **安全证据保存与后续法律入口**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
