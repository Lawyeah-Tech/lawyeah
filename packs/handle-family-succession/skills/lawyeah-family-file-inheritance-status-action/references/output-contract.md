...
1. **主体管辖与争议类型表**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **身份效力争点与证明责任矩阵**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **诉讼请求和起诉状草案**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **证据目录与程序申请清单**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
