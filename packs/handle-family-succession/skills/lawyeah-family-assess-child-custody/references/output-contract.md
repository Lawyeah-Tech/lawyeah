...
1. **子女安全与真实意愿核验**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **最有利因素和反向风险矩阵**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **直接抚养与共同照护情景**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **证据缺口、限制和后续入口**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
