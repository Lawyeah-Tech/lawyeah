...
1. **监护关系、主体与程序核验**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **侵害失职和证据矩阵**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **临时保护与替代监护方案**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **撤销变更申请材料草案**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
