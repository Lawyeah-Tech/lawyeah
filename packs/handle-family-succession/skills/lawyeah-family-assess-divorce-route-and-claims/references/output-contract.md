...
1. **婚姻与安全入口核验**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **协议登记或诉讼路径矩阵**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **请求范围与证据缺口**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **风险、行动顺序与停止事项**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
