...
1. **主体管辖与安全状态表**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
2. **暴力现实危险证据矩阵**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
3. **保护措施请求表**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
4. **保护令申请草案与证据目录**：逐项绑定事实、证据、反向材料、法源状态、限制与下一步。
